...
# })
# bw_gr = fetchWindowedBigwigList(bw_files = bw_files, qgr = olap_fixedSize,
#   win_size = 100)
...
p1 = ssvSignalBandedQuantiles(bw_gr, hsv_symmetric = TRUE, hsv_reverse = TRUE, 
                              hsv_grayscale = TRUE)
p2 = ssvSignalScatterplot(bw_gr, x_name = "MCF10A_CTCF", y_name = "MCF10AT1_CTCF")
p3 = ssvSignalHeatmap(bw_gr)
