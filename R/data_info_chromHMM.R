...
#' URL to download MCF7 chromHMM segmentation
#'
...
#' original state color mappings stored in segmentation bed
#'
#' @details part of \code{\link{chromHMM_demo_data}}
#'
#' @docType data
...
#' overlap of MCF10A CTCF with MCF7 chromHMM states
#'
#' @details part of \code{\link{chromHMM_demo_data}}
...
#' MCF10A CTCF profiles at 20 windows per chromHMM state.
#'
#' @details part of \code{\link{chromHMM_demo_data}}
