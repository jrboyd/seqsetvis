...
#' @param trim_to_valid valid \code{x_} values are those with a set \code{y_} value in all \code{by_} combinations
#' @param check_by_dupes default assumption is that there should be on set of x_ for a by_ instance.
